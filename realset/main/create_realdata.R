...
pa <- "/Users/wyao/Dropbox/RESEARCH/discreteRSF/codes/realset/"
...
# The last min, max and mean of the last 4 columns are the same as the ones in columns 1, 2, 4 and 5 in table 8 of the paper.
# ( except for 131.1 vs 131.4 but that must have been a typo in the paper).


# For the SKHT method: For a given year and a given u, to get the training data set, you can stack the different separate training data sets with the same year and the same u.
# For the superpp method: For a given year, you can stack all training data sets with the same year.

# You don't have to stack the test data sets. Each test data set is used to estimate the performance of a specific (year,t,u) triplet.

# More details are given in the Excel file!!!!!!!
